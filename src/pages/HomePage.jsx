  ...
  return (
    <div className="home-page">
      ...
      <div className="corner-image top-right">
        <img src="/assets/images/lavaStone.png" alt="" aria-hidden="true" />
      </div>
      
      <div className="corner-image bottom-right">
        <img src="/assets/images/eagle.png" alt="" aria-hidden="true" />
      </div>
      
      <div className="corner-image bottom-left">
        <img src="/assets/images/frame.png" alt="" aria-hidden="true" />
    </div>
